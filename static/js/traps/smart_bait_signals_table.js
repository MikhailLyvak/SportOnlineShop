function newUrl(order_by, slug) {
  return `/api/smart_bait_trap_signals/${slug}/?ordering=${order_by}&page=1`;
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateTable(url) {
    fetch(url)
      ...
      .then(data => {
        const tableBody = document.getElementById('smart_bait_signals_table_api').getElementsByTagName('tbody')[0];
        tableBody.innerHTML = '';
