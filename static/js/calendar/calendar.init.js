...
function editEvent(e) {
    ...
    ("new-event" == t ? (document.getElementById("modal-title").innerHTML = "", document.getElementById("modal-title").innerHTML = gettext("Add task"), document.getElementById("btn-save-event").innerHTML = gettext("Add"), eventTyped) : "edit-event" == t ? (e.innerHTML = "Cancel", e.setAttribute("data-id", "cancel-event"), document.getElementById("btn-save-event").innerHTML = "Update Event", e.removeAttribute("hidden"), eventTyped) : (e.innerHTML = "Edit", e.setAttribute("data-id", "edit-event"), eventClicked))()
}
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var g = new bootstrap.Modal(document.getElementById("event-modal"), {
        ...
        e = (new a(), document.getElementById("calendar"));
